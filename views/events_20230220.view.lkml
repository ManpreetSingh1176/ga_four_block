view: events_20230220 {
  sql_table_name: `analytics_266765610.events_20230220`
    ;;
...
view: events_20230220__items {
  ...
  dimension: events_20230220__items {
    type: string
    hidden: yes
    sql: events_20230220__items ;;
  }
...
view: events_20230220__event_params {
  dimension: events_20230220__event_params {
    type: string
    hidden: yes
    sql: events_20230220__event_params ;;
  }
...
view: events_20230220__user_properties {
  dimension: events_20230220__user_properties {
    type: string
    hidden: yes
    sql: events_20230220__user_properties ;;
  }
