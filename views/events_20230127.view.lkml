view: events_20230127 {
  sql_table_name: `analytics_266765610.events_20230127`
    ;;
...
view: events_20230127__items {
  ...
  dimension: events_20230127__items {
    type: string
    hidden: yes
    sql: events_20230127__items ;;
  }
...
view: events_20230127__event_params {
  dimension: events_20230127__event_params {
    type: string
    hidden: yes
    sql: events_20230127__event_params ;;
  }
...
view: events_20230127__user_properties {
  dimension: events_20230127__user_properties {
    type: string
    hidden: yes
    sql: events_20230127__user_properties ;;
  }
