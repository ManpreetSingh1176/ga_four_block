view: events_20230130 {
  sql_table_name: `analytics_266765610.events_20230130`
    ;;
...
view: events_20230130__items {
  ...
  dimension: events_20230130__items {
    type: string
    hidden: yes
    sql: events_20230130__items ;;
  }
...
view: events_20230130__event_params {
  dimension: events_20230130__event_params {
    type: string
    hidden: yes
    sql: events_20230130__event_params ;;
  }
...
view: events_20230130__user_properties {
  dimension: events_20230130__user_properties {
    type: string
    hidden: yes
    sql: events_20230130__user_properties ;;
  }
