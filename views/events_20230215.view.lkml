view: events_20230215 {
  sql_table_name: `analytics_266765610.events_20230215`
    ;;
...
view: events_20230215__items {
  ...
  dimension: events_20230215__items {
    type: string
    hidden: yes
    sql: events_20230215__items ;;
  }
...
view: events_20230215__event_params {
  dimension: events_20230215__event_params {
    type: string
    hidden: yes
    sql: events_20230215__event_params ;;
  }
...
view: events_20230215__user_properties {
  dimension: events_20230215__user_properties {
    type: string
    hidden: yes
    sql: events_20230215__user_properties ;;
  }
