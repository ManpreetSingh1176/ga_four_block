view: events_20230306 {
  sql_table_name: `analytics_266765610.events_20230306`
    ;;
...
view: events_20230306__items {
  ...
  dimension: events_20230306__items {
    type: string
    hidden: yes
    sql: events_20230306__items ;;
  }
...
view: events_20230306__event_params {
  dimension: events_20230306__event_params {
    type: string
    hidden: yes
    sql: events_20230306__event_params ;;
  }
...
view: events_20230306__user_properties {
  dimension: events_20230306__user_properties {
    type: string
    hidden: yes
    sql: events_20230306__user_properties ;;
  }
