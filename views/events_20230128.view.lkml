view: events_20230128 {
  sql_table_name: `analytics_266765610.events_20230128`
    ;;
...
view: events_20230128__items {
  ...
  dimension: events_20230128__items {
    type: string
    hidden: yes
    sql: events_20230128__items ;;
  }
...
view: events_20230128__event_params {
  dimension: events_20230128__event_params {
    type: string
    hidden: yes
    sql: events_20230128__event_params ;;
  }
...
view: events_20230128__user_properties {
  dimension: events_20230128__user_properties {
    type: string
    hidden: yes
    sql: events_20230128__user_properties ;;
  }
