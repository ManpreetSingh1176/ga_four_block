view: events_20230217 {
  sql_table_name: `analytics_266765610.events_20230217`
    ;;
...
view: events_20230217__items {
  ...
  dimension: events_20230217__items {
    type: string
    hidden: yes
    sql: events_20230217__items ;;
  }
...
view: events_20230217__event_params {
  dimension: events_20230217__event_params {
    type: string
    hidden: yes
    sql: events_20230217__event_params ;;
  }
...
view: events_20230217__user_properties {
  dimension: events_20230217__user_properties {
    type: string
    hidden: yes
    sql: events_20230217__user_properties ;;
  }
