view: events_20230225 {
  sql_table_name: `analytics_266765610.events_20230225`
    ;;
...
view: events_20230225__items {
  ...
  dimension: events_20230225__items {
    type: string
    hidden: yes
    sql: events_20230225__items ;;
  }
...
view: events_20230225__event_params {
  dimension: events_20230225__event_params {
    type: string
    hidden: yes
    sql: events_20230225__event_params ;;
  }
...
view: events_20230225__user_properties {
  dimension: events_20230225__user_properties {
    type: string
    hidden: yes
    sql: events_20230225__user_properties ;;
  }
