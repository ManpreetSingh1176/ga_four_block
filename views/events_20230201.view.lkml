view: events_20230201 {
  sql_table_name: `analytics_266765610.events_20230201`
    ;;
...
view: events_20230201__items {
  ...
  dimension: events_20230201__items {
    type: string
    hidden: yes
    sql: events_20230201__items ;;
  }
...
view: events_20230201__event_params {
  dimension: events_20230201__event_params {
    type: string
    hidden: yes
    sql: events_20230201__event_params ;;
  }
...
view: events_20230201__user_properties {
  dimension: events_20230201__user_properties {
    type: string
    hidden: yes
    sql: events_20230201__user_properties ;;
  }
