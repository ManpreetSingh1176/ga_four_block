view: events_20230223 {
  sql_table_name: `analytics_266765610.events_20230223`
    ;;
...
view: events_20230223__items {
  ...
  dimension: events_20230223__items {
    type: string
    hidden: yes
    sql: events_20230223__items ;;
  }
...
view: events_20230223__event_params {
  dimension: events_20230223__event_params {
    type: string
    hidden: yes
    sql: events_20230223__event_params ;;
  }
...
view: events_20230223__user_properties {
  dimension: events_20230223__user_properties {
    type: string
    hidden: yes
    sql: events_20230223__user_properties ;;
  }
