view: events_20230309 {
  sql_table_name: `analytics_266765610.events_20230309`
    ;;
...
view: events_20230309__items {
  ...
  dimension: events_20230309__items {
    type: string
    hidden: yes
    sql: events_20230309__items ;;
  }
...
view: events_20230309__event_params {
  dimension: events_20230309__event_params {
    type: string
    hidden: yes
    sql: events_20230309__event_params ;;
  }
...
view: events_20230309__user_properties {
  dimension: events_20230309__user_properties {
    type: string
    hidden: yes
    sql: events_20230309__user_properties ;;
  }
